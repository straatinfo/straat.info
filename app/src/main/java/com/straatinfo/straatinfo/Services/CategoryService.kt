...
import com.straatinfo.straatinfo.Utilities.GET_GENERAL_MAIN_CATEGORIES
...
object CategoryService {
    ...
    fun getHostMainCategories (hostId: String, language: String): Observable<JSONArray> {
        categoryError = null
...
//                    reportError = err.getString("message") as String
    ...
    fun getGeneralMainCategories (code: String, language: String): Observable<JSONArray> {
        var url = "$GET_GENERAL_MAIN_CATEGORIES?code=$code&language=$language"
